...
class AllProductsSection extends Component {
  ...
  renderProductsList = () => {
    ...
    return totalProducts ? (
      ...
      <div className="no-products-container">
        ...
        />
        <h1 className="no-pds-heading">No Products Found</h1>
        <p className="no-pds-para">
  ...
  renderFailureView = () => (
    <div className="products-failure-container">
      ...
      />
      <h1 className="fa-pds-heading">Oops! Something Went Wrong</h1>
      <p className="fa-pds-para">
  ...
  render() {
    const {categoryId, searchInput, ratingId} = this.state
    ...
    return (
      <div className="all-products-section">
        <FiltersGroup
          ...
          onChangeRating={this.changeRatingId}
